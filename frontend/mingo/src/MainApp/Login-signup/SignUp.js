            ...
            <div className=" panel border bg-white">
                ...
                <form className="signUpform "  encType="multipart/form-data" >
                        <div className="signUpName input-field-div" >
                            <FaceIcon /> <input className="inputF" type="text" placeholder="Name" required name="name"  />
                        </div>

                        <div className="input-field-div">
                        <MailOutlineIcon />
                        <input className="inputF" type="email" placeholder="Email" required name="email" /> 
                        </div>
                        <div className="input-field-div">
                        <MailOutlineIcon />
                        <input className="inputF" type="text" placeholder="Phone No" required name="phone" /> 
                        </div>
                        <div className="input-field-div">
                        <LockOpenIcon />
