                ...
                <div className="panel-body p-3">
                    <form className='loginform' >
                        <div className="form-group py-2">
                            ...
                            <MailOutlineIcon /> 
							<input className="inputF" type="email" placeholder="Email" required /> 
                            </div>
                        </div>
                        <div className="form-group py-1 pb-2">
                            <div className="input-field-div">
                            <LockOpenIcon />
							<input className="inputF" type={showPassword ? "text":"password"} placeholder="Enter your Password"  required/> 
                        ...
                        <div className="text-center pt-4 text-muted">Don't have an account? <Link to="/signup">Sign up</Link> </div>
                    </form>
